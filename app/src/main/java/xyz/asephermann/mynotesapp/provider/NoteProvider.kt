package xyz.asephermann.mynotesapp.provider
...
import xyz.asephermann.mynotesapp.db.DatabaseContract.AUTHORITY
...
class NoteProvider : ContentProvider() {
    ...
    companion object {
        ...
        init {
            // content://xyz.asephermann.mynotesapp/note
            sUriMatcher.addURI(AUTHORITY, TABLE_NAME, NOTE)

            // content://xyz.asephermann.mynotesapp/note/id
